...
class FullyConnectedNet(object):
    ...
    def loss(self, X, y=None):
        ...
        # forward propagate num_layers number of times, where num_layers = num_hidden + 1
        out_forward = X
        ...
        for index in range(self.num_layers-2, -1, -1):
            # index of current layer
            index_str = str(index + 1)
            
            # accounting for regularized loss
